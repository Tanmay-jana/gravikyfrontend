          ...
          this.setState({imgViz: isVisible})
            ...
            <div className = "section3-container">
                <div className = {this.state.scrolled === false ? "section3-subcontainer transparent":"section3-subcontainer"}>
                    <h4>{this.state.imgViz === true ? <CountUp duration={2.75} start={0} end={3} />:0}</h4>
                    <p><span>Fortune 500</span><br/> Clients</p>
                </div>
                <div className = {this.state.scrolled === false ? "section3-subcontainer transparent":"section3-subcontainer"}>
                    <h4>20,{this.state.imgViz === true ? <CountUp duration={2.75} start={490} end={500} />:490}</h4>
                    <p>Liters of <br/><span>AIR-INK</span> produced</p>
                </div>
                <div className = {this.state.scrolled === false ? "section3-subcontainer transparent":"section3-subcontainer"}>
                    <h4>{this.state.imgViz === true ? <CountUp duration={2.75} start={690} end={700} />:690}</h4>
