    ...
    return (
      <div className="partnersection8-container">
        <div className="partnersection8-text-block">
          ...
          <ScrollAnimation animateIn = "fadeIn" className="partnersection8-image-block-responsive">
            <img src={recycle2} alt="recycle2" />
            <img src={recycle4} alt="recycle4" />
            <img src={recycle1} alt="recycle1" />
            <img src={recycle3} alt="recycle3" />
          </ScrollAnimation>
          <a className="artists-link" href="#">
            Check out more on our instagram <img src={arrow} alt="arrow" />
          </a>
        </div>
        <ScrollAnimation animateIn = "fadeIn" className="partnersection8-image-block">
          <img src={recycle2} alt="recycle2" />
          <img src={recycle4} alt="recycle4" />
          <img src={recycle1} alt="recycle1" />
          <img src={recycle3} alt="recycle3" />
